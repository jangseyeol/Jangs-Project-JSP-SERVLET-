...
<body>
	<%
		session.setAttribute("command", "heaven_load_write");
	%>
	<jsp:include page="../header.jsp"></jsp:include>
	<div id="wrap" align="center">
		<h3>천로역정 등록</h3>
		<form name="frm" method="post" action="BoardServlet" enctype="multipart/form-data">
			<input type="hidden" name="command" value="heaven_load_write">
			<table id = "list">
				<tr>
			...
			<input type="button" value="목록"
				onclick="location.href='BoardServlet?command=heaven_load_list&page=1'">
			<br>
			<br><br>
		</form>
	</div>
